...
class SeekBarTypesPresenter(var coordinatorLayout: CoordinatorLayout, var listener: ISettingsPresenter.OnSettingsChangedListener) : BaseSettingsPresenter() {

    companion object {
        private const val POSITION_HEADER = 0
        private const val POSITION_ICON_TITLE_SEEKBAR_VALUE = 1
        private const val POSITION_TITLE_SEEKBAR_MIN_MAX = 2
        private const val POSITION_COLORED_HEADER = 3
        private const val POSITION_COLORED_ICON_TITLE_SEEKBAR_VALUE = 4
        private const val POSITION_COLORED_TITLE_SEEKBAR_MIN_MAX = 5
    }
