...
/**
 * Created by udioshi on 9/5/2017.
 */
public class BasicTypesDividerPresenter extends BaseSettingsPresenter {
    ...
    public List<BaseViewTypeData> getItems(Context context) {
        ...
        HeaderData coloredHeader = new HeaderData("COLORED BASIC ITEMS", R.color.blue);
        items.add(POSITION_COLORED_HEADER, coloredHeader);

        TitleData coloredTitleData = new TitleData("Single title", R.color.red);
        items.add(POSITION_COLORED_SINGLE_TITLE, coloredTitleData);

        items.add(DividerData.create());

        TitleSubtitleData coloredTitleSubtitleData = new TitleSubtitleData("Two rows example", "Simple as that", R.color.blue, R.color.green);
        items.add(POSITION_COLORED_TWO_ROWS, coloredTitleSubtitleData);

        items.add(DividerData.create());

        TitleSubtitleExtraData coloredTitleSubtitleExtraData = new TitleSubtitleExtraData("Three lines ahead", "subtitle is here", R.color.red, R.color.green, "An extra text", R.color.blue);
        items.add(POSITION_COLORED_THREE_ROWS, coloredTitleSubtitleExtraData);

        items.add(DividerData.create(R.color.purple));

        TitleSecondaryTitleData coloredTitleSecondaryTitleData = new TitleSecondaryTitleData("Title & secondary text", R.color.red, "SECONDARY", R.color.blue);
