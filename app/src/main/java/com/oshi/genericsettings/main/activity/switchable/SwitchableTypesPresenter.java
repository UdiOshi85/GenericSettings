...
import com.oshi.libgenericsettings.helper.BindingAdapterHelper;
...
public class SwitchableTypesPresenter extends BaseSettingsPresenter {
    ...
    public SwitchableTypesPresenter(CoordinatorLayout coordinatorLayout, OnSettingsChangedListener l) {
    ...
    public List<BaseViewTypeData> getItems(Context context) {
        ...
        HeaderData coloredHeaderData = new HeaderData("COLORING SWITCHABLE TYPES", R.color.purple);
