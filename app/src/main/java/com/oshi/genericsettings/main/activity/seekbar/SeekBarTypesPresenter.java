...
public class SeekBarTypesPresenter extends BaseSettingsPresenter {
    ...
    public List<BaseViewTypeData> getItems(Context context) {
        ...
        TitleIconSeekBarTextData titleIconSeekBarTextData = new TitleIconSeekBarTextData(R.drawable.ic_android_black_24dp, "Icon, Title, SeekBar & Value text");
        titleIconSeekBarTextData.setSeekBarMaximumValue(100);
        ...
        HeaderData coloredHeaderData = new HeaderData("COLORED SEEKBAR TYPES", R.color.red);
        items.add(POSITION_COLORED_HEADER, coloredHeaderData);

        TitleIconSeekBarTextData coloredTitleIconSeekBarTextData = new TitleIconSeekBarTextData(R.drawable.ic_android_black_24dp, "Colored Icon, Title, SeekBar & Value", R.color.blue);
        ...
        coloredTitleIconSeekBarTextData.setTextColor(R.color.blue);
        coloredTitleIconSeekBarTextData.setSeekBarMaximumValue(100);
